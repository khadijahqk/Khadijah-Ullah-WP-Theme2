 ...
 */
 function khadijahullah_theme_scripts() {
     wp_enqueue_style( 'khadijahullah', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'khadijahullah_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'khadijah-ullah' ),
            'footer-menu' => __( 'Footer Menu', 'khadijah-ullah' ),
            'social-menu' => __( 'Social Menu', 'khadijah-ullah'),
    ...
    // END STEP 2.10 ADD THE add_my_menus
    ...
    function khadijahullah_theme_init(){
    ...
    add_action( 'widgets_init', 'khadijahullah_widgets_init' );
